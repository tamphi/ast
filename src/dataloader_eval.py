...
class AudiosetDataset(Dataset):
    ...
    def _wav2fbank(self, filename, filename2=None):
        ...
        def get_white_noise(signal,SNR) :
            ...
            STD_n=RMS_n
            noise=STD_n*torch.rand(signal.shape)
            return noise
        ...
        def get_noise_from_sound(signal,noise,SNR):
            ...
            RMS_n_current=math.sqrt(torch.mean(noise**2))
        ...
        if filename2 == None:
            ...
            gaussian_mean = 0
            gaussian_var = 0.1
            noise = (gaussian_var**0.5)*torch.randn(wf.shape)
            noise = get_noise_from_sound(wf,noise,snr_dbs)
            if add_noise:
                # print("Adding Gaussian noise, SNR {}".format(snr_dbs))
                wf = wf + noise
            # else:
            #     print("No noise added to signal")
            #end adding noise
